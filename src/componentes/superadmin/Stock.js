...
function Stock() {
    ...
    const guardarAumentar = () => {
        ...
        let datos = { stock: suma, numero: numero, tipo: "Entrada"};
    ...
    const guardarDisminuir = () => {
        ...
        let datos = { stock: resta, numero: numero, tipo: "Salida"};
    ...
    const buscar = async(texto) => {
        ...
        let respuesta = [];
        if(texto == ""){
            respuesta = await axios.get('http://localhost:3005/api/stock');
        }
        else{
            respuesta = await axios.get('http://localhost:3005/api/stock/buscar/' + texto);
        }
        setStock(respuesta.data);
    }
